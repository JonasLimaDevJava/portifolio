...
export const Image=()=>{
    ...
    return(
        <div className=" w-full m-auto  h-full flex flex-col items-center">
            ...
            <h1 className="text-lg text-orange-100 font-serif mt-4">Atuação no Marketing Digital</h1>
            ...
            <p className="text-sm text-justify indent-2 ">Olá! me chamo Jonas sou Desenvolvedor e autor desse portifólio. Atualmente trabalho como " Gestor de trafego e Marketing Digital "
                ...
                digitais para empresa [<strong><a href="https://www.instagram.com/esfihasvitoria" target="_blank">esfihasvitoria</a>, <a href="https://www.instagram.com/esfihasvitoria" target="_blank"> MS Studio de Sobrancelhas e Cílios ]</a></strong> </p>
