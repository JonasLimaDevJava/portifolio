        ...
        <div className="mt-2 rounded-md w-10/12 h-20 m-auto bg-black flex justify-between items-center text-white p-2">
            ...
            <nav className="w-6/12 ">
                <ul className="flex justify-around  ">
                    <li> <a href="/ " className="bg-black mt-4 rounded-md p-1 border-white transition-all border-2 hover:border-transparent hover:bg-orange-300 hover:border-2  ">Home</a></li>
                    <li> <a href="/sobre" className="bg-black mt-4 rounded-md p-1 border-white transition-all border-2 hover:border-transparent hover:bg-orange-300 hover:border-2  ">Sobre</a></li>
